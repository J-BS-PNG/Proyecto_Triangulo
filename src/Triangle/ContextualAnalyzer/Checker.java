...
public final class Checker implements Visitor {
  ...
  public Object visitForCommand(ForCommand ast, Object o) {
    ...
    if (! ast.I.variable)
      reporter.reportError("Identifier is not a variable", "", ast.I.position);
    else if(! (vType instanceof IntTypeDenoter))
        reporter.reportError("Integer expecte here", "", ast.I.position);
  ...
  public Object visitClassTypeDenoter(ClassTypeDenoter ast, Object o) {
   //Hacer codigo
    ...
    ast.fAst = (FieldTypeDenoter) ast.fAst.visit(this, null); 
    idTable.openScope();
      ...
      if(vType instanceof RecordTypeDenoter ){
        ...
        if (ast.type == StdEnvironment.errorType)
          reporter.reportError ("no field \"%\" in this record type",
            ...
            ast.type = checkFieldIdentifier(((ClassTypeDenoter) vType).fAst, ast.I);
            if (ast.type == StdEnvironment.errorType)
              reporter.reportError ("no field \"%\" in this record type",
                                    ast.I.spelling, ast.I.position);
        }
